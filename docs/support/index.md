...
- Tilt it left or right to move and spill the liquid.
- Tap the liquid to switch between beer and cola.
- Tap the drink name at the top, then choose **Refill the glass** to reset it.
